...
<head>
    ...
    <title> Perusahaan Dashboard - Lowongan Kerja</title>
...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            ...
            <div class="subtitle">Perusahaan Panel</div>
        </div>

        <nav class="sidebar-menu">
            <a href="{{ url('/perusahaan/dashboard') }}" class="active">
        ...
        <div class="content-area">
            ...
            <div class="quick-actions fade-in">
                ...
                <div class="d-flex flex-wrap">
                    ...
                    <a href="{{ url('/perusahaan/applications') }}" class="action-btn">
